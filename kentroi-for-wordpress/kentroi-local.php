<?php
/**
 * Plugin Name:       Kentroi for WordPress (Local Dev)
 * Plugin URI:        https://kentroi.com/integrations/wordpress
 * Description:       LOCAL DEVELOPMENT VERSION - Connects to localhost:3000. Embed Kentroi booking widgets, contact forms, and AI chatbots on your WordPress site.
 * Version:           1.0.0-local
 ...
 */
define( 'KENTROI_VERSION', '1.0.0-local' );
...
/**
 * Kentroi API base URL - LOCAL DEVELOPMENT via ngrok.
 */
define( 'KENTROI_API_URL', 'https://lazaro-unprim-christine.ngrok-free.dev/api' );

/**
 * Kentroi embed base URL - LOCAL DEVELOPMENT via ngrok.
 */
define( 'KENTROI_EMBED_URL', 'https://lazaro-unprim-christine.ngrok-free.dev' );

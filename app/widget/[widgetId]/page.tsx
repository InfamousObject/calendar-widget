...
import { Calendar, FileText, X, ArrowLeft, Check } from 'lucide-react';
...
type View = 'menu' | 'booking' | 'form' | 'success';
...
// Menu View Component
function MenuView({ config, onSelectBooking, onSelectForm }: any) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        {hasBooking && (
          <>
            <h3 className="font-medium text-sm text-muted-foreground">Book an Appointment</h3>
